...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      BJ: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      BK: x0 => x0.statusText,
      BL: (x0,x1) => x0.start(x1),
      ...
      FJ: (x0,x1,x2) => x0.insertRule(x1,x2),
      FK: x0 => x0.read(),
      FL: x0 => x0.videoWidth,
      ...
      IJ: x0 => x0.preventDefault(),
      IK: x0 => x0.cancel(),
      IL: (x0,x1) => { x0.playsInline = x1 },
      ...
      JJ: x0 => x0.createRange(),
      JK: x0 => x0.body,
      JL: (x0,x1) => { x0.controls = x1 },
      K: (exn) => {
      ...
      KJ: (x0,x1) => x0.selectNode(x1),
      KK: x0 => x0.headers,
      KL: (x0,x1) => { x0.autoplay = x1 },
      L: o => o === undefined,
      ...
      LJ: x0 => x0.getSelection(),
      LK: x0 => x0.signal,
      LL: x0 => x0.currentTime,
      M: o => String(o),
      MB: (o, p) => o[p],
      ...
      MH: (x0,x1) => { x0.name = x1 },
      MI: x0 => x0.style,
      MJ: x0 => x0.removeAllRanges(),
      MK: (x0,x1,x2) => x0.insertBefore(x1,x2),
      ML: (x0,x1) => { x0.playbackRate = x1 },
      N: (c) =>
      ...
      PH: (x0,x1) => { x0.type = x1 },
      PI: x0 => x0.src,
      PJ: (x0,x1) => { x0.innerText = x1 },
      PK: x0 => x0.offsetWidth,
      PL: x0 => x0.message,
      ...
      TI: (x0,x1,x2,x3,x4,x5) => x0.createImageBitmap(x1,x2,x3,x4,x5),
      TJ: x0 => x0.classList,
      TK: (x0,x1) => { x0.max = x1 },
      ...
      UI: (x0,x1) => x0.createImageBitmap(x1),
      UJ: x0 => x0.sheet,
      ...
      WI: x0 => x0.close(),
      WJ: x0 => x0.pop(),
      WK: (x0,x1) => { x0.spellcheck = x1 },
      WL: x0 => x0.preventDefault(),
      X: o => [o],
      XB: (t, s) => t.set(s),
      ...
      XJ: x0 => x0.input,
      XK: (x0,x1) => { x0.disabled = x1 },
      XL: x0 => x0.firstElementChild,
      Y: (o0, o1) => [o0, o1],
      ...
      aJ: () => globalThis.window.navigator.userAgent,
      ...
      bJ: (x0,x1,x2) => x0.postMessage(x1,x2),
      ...
      fK: x0 => x0.canvasKitMaximumSurfaces,
      ...
      hI: (x0,x1,x2,x3,x4) => ({type: x0,data: x1,premultiplyAlpha: x2,colorSpaceConversion: x3,preferAnimation: x4}),
      hJ: (x0,x1) => { x0.width = x1 },
      hK: (x0,x1) => x0.debug(x1),
      hL: (x0,x1) => { x0.preload = x1 },
      i: (l, r) => l === r,
      ...
      iI: x0 => new window.ImageDecoder(x0),
      iJ: x0 => x0.style,
      iK: x0 => x0.hostElement,
      iL: x0 => x0.src,
      j: x0 => x0.random(),
      ...
      kI: x0 => x0.repetitionCount,
      kJ: (x0,x1) => x0.createElement(x1),
      kK: (x0,x1) => x0.getModifierState(x1),
      kL: x0 => x0.length,
      l: o => {
        if (o === undefined || o === null) return 0;
      ...
      qK: x0 => x0.repeat,
      qL: (x0,x1) => new OffscreenCanvas(x0,x1),
      r: (x0,x1) => x0.focus(x1),
      ...
      sJ: (x0,x1) => { x0.src = x1 },
      sK: (x0,x1) => x0.removeAttribute(x1),
      sL: x0 => x0.loader,
      t: (o, p, v) => o[p] = v,
      ...
      tI: x0 => x0.decode(),
      tJ: (x0,x1) => { x0.srcdoc = x1 },
      tK: x0 => x0.load(),
      tL: () => globalThis._flutter,
      u: () => [],
      ...
      vJ: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      vK: (x0,x1) => { x0.volume = x1 },
      ...
      wG: x0 => x0.minHeight,
      wH: (a, i) => a.splice(i, 1),
      wI: (x0,x1,x2) => x0.addEventListener(x1,x2),
      wJ: (x0,x1) => globalThis.fetch(x0,x1),
      wK: (x0,x1) => { x0.muted = x1 },
